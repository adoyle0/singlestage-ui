                    ...
                    <SidebarMenu>
                        <For
                            ...
                            children=|item: NavItem| {
                                let open = RwSignal::new(item.open);
                                                ...
                                                <SidebarMenuButton>
                                                    <Button>
                                                        ...
                                                        <Show
                                                            when=move || { open.get() }
                                                            fallback=move || {
                                                                view! { {icon!(icondata::LuPlus, class="ml-auto")} }
                                                            }
                                                        >
                                                            {icon!(icondata::LuMinus, class="ml-auto")}
                                                        </Show>
                                                    </Button>
                                                </SidebarMenuButton>
                                            </SidebarMenuItem>
...
#[component]
pub fn SidebarCollapsibleSubmenusExample() -> impl IntoView {
