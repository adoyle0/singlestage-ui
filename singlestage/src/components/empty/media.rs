...
/// Use the EmptyMedia component to display the media of the empty state such as an icon or an
/// image. You can also use it to display other components such as an avatar.
#[component]
pub fn EmptyMedia(
    children: Children,

    /// Select which variant to render.
    /// Accepted values: "icon".
    #[prop(optional, into)]
